...
\frac{d}{dx}\left(E(x)\frac{du}{dx}\right)=xk^3\cos{(\gamma x)}\\
\end{aligned}
\end{equation}
...
\begin{equation}
\label{eq:Problem2}
\frac{du}{dx}=\frac{1}{E}\left\lbrack \frac{xk^3}{\gamma}\sin{(\gamma x)}+\frac{k^3}{\gamma^2}\cos{(\gamma x)}+C_1\right\rbrack
\end{equation}
...
\begin{equation}
\label{eq:Problem3}
u(x)=\frac{1}{E}\left\lbrack\frac{-xk^3}{\gamma^2}\cos{(\gamma x)}+\frac{2k^3}{\gamma^3}\sin{(\gamma x)}+C_1x+C_2\right\rbrack
\end{equation}
...
\begin{equation}
\begin{aligned}
w=\left\lbrack-\frac{1}{3}\sqrt{5-2\sqrt{10/7}}, -\frac{1}{3}\sqrt{5-2\sqrt{10/7}}, 0, \frac{1}{3}\sqrt{5-2\sqrt{10/7}}, \frac{1}{3}\sqrt{5-2\sqrt{10/7}}\right\rbrack\\
x=\left\lbrack\frac{322-13\sqrt{70}}{900}, \frac{322+13\sqrt{70}}{900}, \frac{128}{225}, \frac{322+13\sqrt{70}}{900}, \frac{322-13\sqrt{70}}{900}\right\rbrack\\
\end{aligned}
\end{equation} 
