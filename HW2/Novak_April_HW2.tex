...
Table \ref{table:orders} shows the number of elements needed to reach the tolerance given by Eq. \eqref{eq:Convergence} as a function of the polynomial order of the approximation functions.
